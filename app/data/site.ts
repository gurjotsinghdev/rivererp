...
export const poweredItems = [
  'ERPNext core + River ERP plugins',
  '$5 sandbox → production cutover',
  'Calendly-only CTA; no forms',
  'Demo: rivererp@gmail.com',
  'Setup: info.somydigital@gmail.com',
  'Governance + certifications ready'
];

export const featureCards = [
  { title: 'River ERP Core', description: 'Finance, inventory, CRM, approvals, analytics.', tag: 'Included' },
  { title: 'Agents & automations', description: 'Bots to triage tickets, approvals, and tasks.', tag: 'Automations' },
  { title: 'Domain plugins', description: 'School, College, Company Ops, Ecommerce layers.', tag: 'Plugins' },
  { title: 'Composable workflows', description: 'Mix modules, custom fields, and scripts freely.', tag: 'Composable' },
  { title: 'Multi-tenant ready', description: 'Sandboxes, demo tenants, and hardened prod.', tag: 'Demo + prod' },
  { title: 'Observability', description: 'Health, automation success, adoption dashboards.', tag: 'Visibility' },
...
export const pipelineSteps = [
  ...
  'Provision River ERP Core baseline',
  'Layer plugins (School, College, Company, Ecommerce)',
  'Connect Gmail, domain, Calendly, and demo tenant (rivererp@gmail.com)',
  'Certifications, playbooks, governance, launch'
];

export const plans = [
  { name: 'Launch', price: '$199/mo', setup: '$500 setup', bullets: ['Core modules', 'Up to 15 users', 'Essential automations', 'Guided onboarding'] },
  { name: 'Growth', price: '$499/mo', setup: '$2000 setup', bullets: ['Advanced workflows', 'Custom scripts & dashboards', 'Data migration + integrations', 'Priority success'], accent: true },
  { name: 'Scale', price: '$999/mo', setup: '$5000 setup', bullets: ['Multi-entity', 'Dedicated sandbox', 'Automation across finance/ops/CRM', 'Quarterly optimization'] },
  { name: 'Enterprise', price: 'Contact us', setup: 'Custom setup', bullets: ['Custom modules', 'SSO, governance, SLAs', 'Data residency/perf reviews', 'Dedicated delivery squad'] }
];

export const testimonials = [
  {
    quote: '“River ERP handled setup, plugins, and training—our teams used it day one.”',
    name: 'Alex Morgan',
    title: 'COO',
    company: 'Harbor Inn',
...
export const faqs = [
  ...
  { q: 'Do you support custom ERPNext apps?', a: 'Yes. River ERP Core plus plugins; we add custom apps, fields, scripts, and integrations.' },
  { q: 'How long to go live?', a: 'Typical go-live ~60 days from sign-off, including migration, enablement, and governance.' },
...
export const footerColumns = [
  {
    heading: 'Product',
    links: ['ERPNext core', 'River ERP plugins', 'Industries', 'Pricing']
  },
  {
    heading: 'Company',
    links: ['About', 'Case studies', 'Testimonials', 'Contact']
  },
  {
    heading: 'Resources',
    links: ['FAQ', 'Book consultation', 'Demo tenant', 'Governance']
  }
];
